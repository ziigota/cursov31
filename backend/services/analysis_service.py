...
class AnalysisService:
    ...
    def analyze_distributions(df: pd.DataFrame, features: List[str] = None) -> Dict:
        ...
        stats = {}
        interpretations = {
            "loudness": "Громкость измеряется в дБ. Среднее значение показывает типичную громкость треков. Большинство современных треков имеют громкость около -6 dB из-за 'loudness war' в музыкальной индустрии.",
